...
import {  Keyboard, Text, TextInput, TouchableOpacity,SafeAreaView, View } from "react-native";
...
export default function Signup({params, route}) {
                    ...
                    
                        {
                            credReg? (
                                ...
                                <View  style={[styles.container,  styles.centerAlign, ]}>
                                         ...
                                         onChangeText={(val)=>{ setCreds({...creds, name: val})}}
                                       ...
                                       <TextInput
                                         ...
                                         placeholder="Email"
                                         placeholderTextColor={'#c9c9c9'}
                                         onChangeText={(val)=>{ setCreds({...creds, email: val})}}
                                         keyboardType="email-address"
                                         value={creds.email}
                                        />
                                       ...
                                       <TextInput
                                        ...
                                        />
                                         ...
                                         placeholderTextColor={'#c9c9c9'}
                                         onChangeText={(val)=>{ setCreds({...creds,confirm_password: val})}}
                               ...
                               onPress={()=>{  setCredreg(!credReg)}}
                             />  )
                        }
                         {
                     !focus?(
                            <TouchableOpacity >
                                     <SvgCss xml={googleLogin} width="300px" height="60px" style={{marginBottom: 20 ,borderRadius: 10 }}  />
                        </TouchableOpacity>
                         ): (<></>)
                    }
